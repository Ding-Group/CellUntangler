...
# NOTICE: This file has been modified from its original form.
# ==============================================================================
...
class RotatedWrappedNormal(torch.distributions.Distribution, VaeDistribution):
    arg_constraints = {
    ...
    def __init__(self, loc: Tensor, scale: Tensor, manifold: Manifold, *args: Any, **kwargs: Any) -> None:
        ...
        # base_axis[..., 0] = torch.where(loc[..., 0] >= 0, 1, -1)
